...
public class Gift extends AbstractEntity {
    ...
    public Gift(
        ...
        if (StringUtils.isBlank(giftReceiverName)) throw new InvalidParamException("Gift constructor giftReceiverName is empty");
        if (StringUtils.isBlank(giftReceiverPhone)) throw new InvalidParamException("Gift constructor giftReceiverPhone is empty");
        if (StringUtils.isBlank(giftMessage)) throw new InvalidParamException("Gift constructor giftMessage is empty");
